    ...
    <section style={{ padding: '140px 0', background: 'var(--cream)' }} className="founders-section">
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }} className="founders-grid">
          ...
          {/* Jin */}
          <div style={{ background: 'rgba(107,163,200,0.06)', borderRadius: '24px', padding: '48px', position: 'relative', overflow: 'hidden', border: '0.5px solid rgba(107,163,200,0.12)' }}>
            <div style={{ position: 'absolute', top: '32px', right: '32px', fontFamily: 'var(--font-fraunces), serif', fontStyle: 'italic', fontWeight: 300, fontSize: '80px', color: 'rgba(107,163,200,0.12)', lineHeight: 1, letterSpacing: '-0.03em', pointerEvents: 'none' }}>Jin</div>
            ...
            <div style={{ borderTop: '0.5px solid rgba(107,163,200,0.15)', paddingTop: '24px' }}>
          ...
          {/* Jo */}
          <div style={{ background: 'var(--dark-brown)', borderRadius: '24px', padding: '48px', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', top: '32px', right: '32px', fontFamily: 'var(--font-fraunces), serif', fontStyle: 'italic', fontWeight: 300, fontSize: '80px', color: 'rgba(168,203,224,0.08)', lineHeight: 1, letterSpacing: '-0.03em', pointerEvents: 'none' }}>Jo</div>
            <div style={{ marginBottom: '24px' }}>
              <div style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '10px', fontWeight: 500, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(168,203,224,0.7)', marginBottom: '10px' }}>
                Co-founder · Tokyo 🇯🇵
              </div>
              <div style={{ fontFamily: 'var(--font-fraunces), serif', fontSize: '28px', fontWeight: 400, color: 'white', letterSpacing: '-0.02em' }}>Jo</div>
            </div>
            <div style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '10px', fontWeight: 500, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(168,203,224,0.7)', marginBottom: '8px' }}>
              Japan curator
            </div>
            ...
            <div style={{ borderTop: '0.5px solid rgba(168,203,224,0.15)', paddingTop: '24px' }}>
        ...
        <div style={{ marginTop: '40px', textAlign: 'center' }}>
          <a href="/about" style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '13px', fontWeight: 400, color: 'var(--brown)', textDecoration: 'none', border: '0.5px solid rgba(107,163,200,0.2)', padding: '12px 28px', borderRadius: '99px', display: 'inline-block', transition: 'all 0.2s' }}>
            More about us →
          </a>
        </div>
