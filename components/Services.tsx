    ...
    <section id="services" className="services-section" style={{ padding: '140px 0', background: '#FEFAF0' }}>
      <div className="container">
        ...
        <div className="service-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px' }}>
          <ServiceCard num="01" icon={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6BA3C8" strokeWidth="1.4"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>}
          ...
          <ServiceCard num="02" icon={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6BA3C8" strokeWidth="1.4"><path d="M3 9l9-6 9 6v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9z"/><polyline points="3 9 12 15 21 9"/></svg>}
          ...
          <ServiceCard num="03" icon={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6BA3C8" strokeWidth="1.4"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>}
...
function ServiceCard({ num, icon, title, body, detailLabel, detailVal }: { num: string; icon: React.ReactNode; title: React.ReactNode; body: string; detailLabel: string; detailVal: string }) {
  return (
    <div className="svc-card" style={{ background: 'var(--cream)', borderRadius: '20px', padding: '48px 36px', position: 'relative', transition: 'all 0.3s ease', border: '0.5px solid transparent' }}>
      <div style={{ position: 'absolute', top: '36px', right: '36px', fontFamily: 'var(--font-fraunces), serif', fontStyle: 'italic', fontWeight: 300, fontSize: '44px', color: 'rgba(107,163,200,0.15)', lineHeight: 1 }}>{num}</div>
      <div style={{ width: '56px', height: '56px', borderRadius: '16px', background: 'rgba(107,163,200,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '28px', border: '0.5px solid rgba(107,163,200,0.15)' }}>{icon}</div>
      ...
      <div style={{ paddingTop: '20px', borderTop: '0.5px solid rgba(107,163,200,0.15)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
