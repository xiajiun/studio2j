...
const BRANDS: { name: string; korean?: string; instagram?: string; image?: string; url?: string; country?: string; booth?: string; post?: string; category: string }[] = [
  ...
  { name: '청록', instagram: '_cheongnok', booth: 'H11', post: 'https://www.instagram.com/p/DYAdLAFDwt1/', category: 'All brands' },
  { name: '초코메로', instagram: 'chocom3ro', booth: 'B15', post: 'https://www.instagram.com/p/DXzKCNflPEX/', category: 'All brands' },
  { name: '치리클럽', instagram: 'cheeryiclub', booth: 'A03', post: 'https://www.instagram.com/p/DYBXjl0E1sg/', category: 'All brands' },
  ...
  { name: '파사', instagram: 'pasa.aori', booth: 'H10', post: 'https://www.instagram.com/p/DRg6BoJjioA/', category: 'All brands' },
  ...
  { name: '평화조각', instagram: 'pyunghwa_jogak', booth: 'F08', post: 'https://www.instagram.com/p/DX4CdjvEjPv/', category: 'All brands' },
  ...
  { name: '포포', instagram: 'popo_for_u', booth: 'C13', post: 'https://www.instagram.com/p/DT99HGwDxSU/', category: 'All brands' },
  { name: '폴랑폴랑', instagram: 'pollang2', booth: 'E20', post: 'https://www.instagram.com/p/DX10alzERKD/', category: 'All brands' },
  ...
  { name: 'FLUFFYS', booth: 'K05', category: 'All brands' },
  ...
  { name: '나나스무드', instagram: 'nanasmood', booth: 'A04', post: 'https://www.instagram.com/p/DYCAPArASCi/', category: 'All brands' },
  { name: '나로메로 캔디', instagram: 'nar0_0mero_o', booth: 'D18', post: 'https://www.instagram.com/p/DX_r7JHklSw/', category: 'All brands' },
  ...
  { name: '낭만', instagram: 'my_youth__diary', booth: 'B02', category: 'All brands' },
  { name: '넛코코', instagram: 'nutcoco_s', booth: 'E02', post: 'https://www.instagram.com/p/DX4JvOXE-yb/', category: 'All brands' },
  { name: '네버더레스', instagram: 'wwwneverthelesscom', booth: 'F06', post: 'https://www.instagram.com/p/DXygPiLk6Bs/', category: 'All brands' },
  { name: '단팥', instagram: 'danpat_s', booth: 'E12', post: 'https://www.instagram.com/p/DX1p9QJk7qI/', category: 'All brands' },
  { name: '더프린티드걸', instagram: 'theprintedgrl', booth: 'G09', post: 'https://www.instagram.com/p/DX1rr2OE1CJ/', category: 'All brands' },
  { name: '덩이나라', instagram: 'dung2nara', booth: 'F07', post: 'https://www.instagram.com/p/DXynhZ6kYku/', category: 'All brands' },
  { name: '도꾸마리', instagram: 'dokkumalee', booth: 'K08', post: 'https://www.instagram.com/p/DX4IOvCgU7g/', category: 'All brands' },
  { name: '도르', instagram: 'open_dorlog', booth: 'E16', post: 'https://www.instagram.com/p/DXzHIUcEqb1/', category: 'All brands' },
  { name: '도미월드', instagram: 'domi__i', booth: 'D08', category: 'All brands' },
  ...
  { name: '리코마루', instagram: 'rico_maruu', booth: 'J03', post: 'https://www.instagram.com/p/DWoe1s0k23x/', category: 'All brands' },
  { name: '리틀타이니룸', instagram: 'littletinyroom', booth: 'B11', post: 'https://www.instagram.com/p/DYFXtV5FMXx/', category: 'All brands' },
  { name: '마고즈', instagram: 'hajimagomin', booth: 'E01', post: 'https://www.instagram.com/p/DX_WqeZmcQV/', category: 'All brands' },
  ...
  { name: '모루', booth: 'B20', category: 'All brands' },
  { name: '모리마', instagram: 'molima.shop', booth: 'G11', post: 'https://www.instagram.com/p/DX4Uhf3kv0Z/', category: 'All brands' },
  { name: '모모이하우스', instagram: 'momoi_house', booth: 'A12', post: 'https://www.instagram.com/p/DXygvzlE-Zb/', category: 'All brands' },
  { name: '무디클럽', instagram: 'moodyclu_b', booth: 'J07', post: 'https://www.instagram.com/p/DX6r-KXj5bu/', category: 'All brands' },
  ...
  { name: '미료코', instagram: 'miryoco', booth: 'F03', post: 'https://www.instagram.com/p/DYEg8Kwjm-H/', category: 'All brands' },
  { name: '미타코어', instagram: 'metiny_0429', booth: 'K13', post: 'https://www.instagram.com/p/DYAFWBPn2jJ/', category: 'All brands' },
  ...
  { name: '별사세', instagram: 'byeolsase', booth: 'F15', post: 'https://www.instagram.com/p/DXwX72ZkQa9/', category: 'All brands' },
  { name: '보링보링', instagram: 'shop.boringboring', booth: 'G13', post: 'https://www.instagram.com/p/DX1oLLqkyQ6/', category: 'All brands' },
  { name: '블랙레터', instagram: 'blackletter_kr', booth: 'B04', post: 'https://www.instagram.com/p/DX9S9iVEZVK/', category: 'All brands' },
  { name: '빙빙문구', instagram: 'bingbing_mungu', booth: 'F19', post: 'https://www.instagram.com/p/DX_cAWlk6J_/', category: 'All brands' },
  { name: '뽁뽁즈', instagram: 'ppokppokz', booth: 'B07', post: 'https://www.instagram.com/p/DXWGeTpEw6u/', category: 'All brands' },
  { name: '서리꽃', instagram: 'seorikkoch', booth: 'A09', post: 'https://www.instagram.com/p/DX0uXW5Et3I/', category: 'All brands' },
  { name: '소녀교실', instagram: 'sonyeokyosil', booth: 'D15', post: 'https://www.instagram.com/p/DJyUashR4Fz/', category: 'All brands' },
  { name: '소누', instagram: 'sonu_choi_', booth: 'K01', post: 'https://www.instagram.com/p/DX2BLT9k6k-/', category: 'All brands' },
  { name: '소랏', instagram: 'sorat_illust', booth: 'G19', post: 'https://www.instagram.com/p/DX9ODPuk65H/', category: 'All brands' },
