...
const BRANDS: { name: string; korean?: string; instagram?: string; image?: string; url?: string; country?: string; booth?: string; post?: string; category: string }[] = [
  ...
  { name: '청록', instagram: '_cheongnok', booth: 'H11', category: 'All brands' },
  ...
  { name: '나나스무드', instagram: 'nanasmood', booth: 'A04', category: 'All brands' },
  { name: '나로메로 캔디', instagram: 'nar0_0mero_o', booth: 'D18', category: 'All brands' },
  ...
  { name: '도르', booth: 'E16', category: 'All brands' },
  ...
  { name: '스닙스니페티스닙', instagram: 'leenahoo_drawing', booth: 'A11', category: 'All brands' },
