  ...
  return (
    <div>
      ...
      <div style={{ fontFamily: 'var(--font-inter), sans-serif', fontSize: '12px', fontWeight: 300, color: 'var(--tan)', marginBottom: '40px', display: 'flex', gap: '10px' }}>
        ...
        <span style={{ color: 'rgba(200,169,141,0.4)' }}>·</span>
        <Link href={`/order/${o.order_number}`} target="_blank" style={{ color: 'var(--dark-blue)', textDecoration: 'none' }}>Customer view ↗︎</Link>
        <span style={{ color: 'rgba(200,169,141,0.4)' }}>·</span>
        <Link href={`/admin/orders/${o.id}/invoice`} target="_blank" style={{ color: 'var(--dark-blue)', textDecoration: 'none' }}>Invoice ↗︎</Link>
        {o.tracking_number && (
          <>
            <span style={{ color: 'rgba(200,169,141,0.4)' }}>·</span>
            <ShippedEmailButton
        ...
        <div>
          ...
          <OrderForm
            ...
            initial={{
              ...
              actual_shipping_cost: o.actual_shipping_cost?.toString() ?? '',
              runner_fee:           o.runner_fee?.toString() ?? '',
            }}
          />
        </div>
